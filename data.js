...
/* ══════ Watch Versatility Metadata ══════ */
/* dc = dial color keys for compat(), dialNeutral = safe with everything,
   twoTone = mixed-metal versatility, isNeutralAnchor = max-versatile pieces */
const WATCH_META={
"snowflake":{dc:["silver","white"],dialNeutral:true,isNeutralAnchor:true},
"rikka":{dc:["green"]},
"sbgw267":{dc:["ivory","cream"],dialNeutral:true},
"laureato":{dc:["blue"]},
"reverso":{dc:["navy"]},
"santos-lg":{dc:["white","gold"],twoTone:true,dialNeutral:true,isNeutralAnchor:true},
"santos-oct":{dc:["white","gold"],twoTone:true},
"bb41":{dc:["black","red"],isNeutralAnchor:true},
"monaco":{dc:["black"],dialNeutral:true},
"gmt":{dc:["black"],dialNeutral:true},
"alpine-8hf":{dc:["blue","grey"],isNeutralAnchor:true},
"hanhart":{dc:["white","teal"]},
"laco":{dc:["black"],dialNeutral:true},
"speedy":{dc:["black"],dialNeutral:true,isNeutralAnchor:true},
"iwc-perp":{dc:["blue","navy"]},
"iwc-ing":{dc:["teal"]},
"vc-perp":{dc:["burgundy"]},
"santos-rep":{dc:["white"],dialNeutral:true},
"alpine-red":{dc:["red"],twoTone:true},
"ap-roc":{dc:["green"]},
"gmt-met":{dc:["grey"],dialNeutral:true},
"dd-turq":{dc:["turquoise"],twoTone:true},
"op-grape":{dc:["purple"]},
